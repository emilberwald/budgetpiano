...
class GrayscaleMatcher:
    ...
    def get_homography(self, gray):
        self._update(gray)
        return self.homography

    def _update(self, gray):
        query_keypoints = self.detector.detect(gray, None)
        query_keypoints, query_descriptors = self.descriptor.compute(gray, query_keypoints)
